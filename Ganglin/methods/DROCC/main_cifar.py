...
def main():
    ...
    dataset = CIFAR10_Dataset("./Ganglin/data", args.normal_class)
    train_loader, test_loader = dataset.loaders(batch_size=args.batch_size, num_workers=0)
    ...
    if args.eval == 0:
        ...
        if os.path.exists(os.path.join(args.model_dir, 'model.pt')):
            ...
            exit()
        score = trainer.test(test_loader, 'AUC',dataset_name=dataset_name)
        # image_cv = cv2.imread('dog_manga2.png')
        # dim = (32, 32)
        # image = cv2.resize(image_cv, dim)
        # plt.imshow(image)
        # plt.savefig("dog2_test.png")
        # score = trainer.test_one_img(image, 'AUC')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', type=str, default='cifra10') # "cifra10", "kaggle_testset"
    ...
    main()
    # python main_cifar.py  --lamda 1  --radius 8 --lr 0.001 --gamma 1 --ascent_step_size 0.001 --batch_size 256 --epochs 100 --eval 0 --optim 0 --normal_class 0 --dataset_name "cifra10"
