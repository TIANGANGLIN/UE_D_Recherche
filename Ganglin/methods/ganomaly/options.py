...
class Options():
    ...
    def __init__(self):
        ...
        ##
        # Base
        self.parser.add_argument('--eval', default=1)
        self.parser.add_argument('--dataset', default='cifar10', help='folder | cifar10 | mnist ')
        self.parser.add_argument('--dataset_name', default='cifar10')
        ...
        self.parser.add_argument('--abnormal_class', default='dog', help='Anomaly class idx for mnist and cifar datasets')
